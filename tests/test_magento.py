...
def test_menu_items(browser_shop):
    for i in range(3, 9):
        btn = WebDriverWait(browser_shop, 10).until(EC.element_to_be_clickable((By.ID, f'ui-id-{i}')))
        btn.click()

        if i == 3:
            assert browser_shop.current_url == "https://magento.softwaretestingboard.com/what-is-new.html"
        elif i == 4:
            assert browser_shop.current_url == "https://magento.softwaretestingboard.com/women.html"
        elif i == 5:
            assert browser_shop.current_url == "https://magento.softwaretestingboard.com/men.html"
        elif i == 6:
            assert browser_shop.current_url == "https://magento.softwaretestingboard.com/gear.html"
        elif i == 7:
            assert browser_shop.current_url == "https://magento.softwaretestingboard.com/training.html"
        elif i == 8:
            assert browser_shop.current_url == "https://magento.softwaretestingboard.com/sale.html"
...
def test_title_whatsnew(browser_shop):
    item = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, 'ui-id-3')))
    item.click()
...
def test_copyright_message(browser_shop):
    for i in range(3, 9):
        item = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, f'ui-id-{i}')))
        item.click()
...
def test_title_women(browser_shop):
    item = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, 'ui-id-4')))
    item.click()
...
def test_title_women_submenu_tops_jackets(browser_shop):
    menu = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, 'ui-id-4')))
    menu.click()
...
def test_element_women_submenu_tops_jackets(browser_shop):
    ...
    element = browser_shop.find_element(By.XPATH, '//*[@id="narrow-by-list"]/div[8]/div[1]')
...
def test_title_men(browser_shop):
    item = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, 'ui-id-5')))
    item.click()
...
def test_title_men_submenu_bottoms_pants(browser_shop):
    menu = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, 'ui-id-5')))
    menu.click()
    submenu = browser_shop.find_element(By.PARTIAL_LINK_TEXT, 'Bottoms')
    actions = ActionChains(browser_shop)
...
def test_element_men_submenu_bottoms_pants(browser_shop):
    ...
    element = browser_shop.find_element(By.XPATH, '//*[@id="narrow-by-list"]/div[9]/div[1]')
...
def test_title_gear(browser_shop):
    item = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, 'ui-id-6')))
    item.click()
...
def test_title_gear_submenu_bags(browser_shop):
    menu = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, 'ui-id-6')))
    menu.click()
...
def test_title_training(browser_shop):
    item = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, 'ui-id-7')))
    item.click()
...
def test_title_training_submenu_video_download(browser_shop):
    menu = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, 'ui-id-7')))
    menu.click()
...
def test_element_training_submenu_video_download(browser_shop):
    ...
    element = browser_shop.find_element(By.XPATH,
...
def test_title_sale(browser_shop):
    item = WebDriverWait(browser_shop, 5).until(EC.element_to_be_clickable((By.ID, 'ui-id-8')))
    item.click()
